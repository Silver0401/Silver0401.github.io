...
const InitSection: React.FC<props> = ({ sectionRef }) => {
  ...
  const MedRef = useRef<HTMLAnchorElement>(null);
  const CodeRef = useRef<HTMLAnchorElement>(null);
  const ModelingRef = useRef<HTMLAnchorElement>(null);
  const XpRef = useRef<HTMLAnchorElement>(null);
  ...
  const MedIsHovering = useHover(MedRef);
  const CodeIsHovering = useHover(CodeRef);
  const ModelingIsHovering = useHover(ModelingRef);
  const XpIsHovering = useHover(XpRef);
  const LangIsHovering = useHover(LangRef);
  const MusicIsHovering = useHover(MusicRef);
  const DesignIsHovering = useHover(DesignRef);
  const WhyIsHovering = useHover(WhyRef);
        ...
        <div className="CirclesBoxBox">
          ...
          <div className="innerHiddenCircle">
            ...
            <h3
              id="CodeBallText"
              style={{
                opacity: CodeIsHovering ? 1 : 0,
                transition: "opacity 600ms",
              }}
            >
              {t("InitSection.Code.BallTitle")}
            </h3>
            <h3
              id="LangBallText"
              style={{
                opacity: LangIsHovering ? 1 : 0,
                transition: "opacity 600ms",
              }}
            >
              {t("InitSection.Lang.BallTitle")}
            </h3>
            <h3
              id="ModelingBallText"
              style={{
                opacity: ModelingIsHovering ? 1 : 0,
                transition: "opacity 600ms",
              }}
            >
              {t("InitSection.Modeling.BallTitle")}
            </h3>
            <h3
              id="WhyBallText"
              style={{
                opacity: WhyIsHovering ? 1 : 0,
                transition: "opacity 600ms",
              }}
            >
              {t("InitSection.Why.BallTitle")}
            </h3>
            <h3
              id="MedBallText"
              style={{
                opacity: MedIsHovering ? 1 : 0,
                transition: "opacity 600ms",
              }}
            >
              {t("InitSection.Med.BallTitle")}
            </h3>
            <h3
              id="DesignBallText"
              style={{
                opacity: DesignIsHovering ? 1 : 0,
                transition: "opacity 600ms",
              }}
            >
              {t("InitSection.Design.BallTitle")}
            </h3>
            <h3
              id="MusicBallText"
              style={{
                opacity: MusicIsHovering ? 1 : 0,
                transition: "opacity 600ms",
              }}
            >
              {t("InitSection.Music.BallTitle")}
            </h3>
            <h3
              id="XpBallText"
              style={{
                opacity: XpIsHovering ? 1 : 0,
                transition: "opacity 600ms",
              }}
            >
              {t("InitSection.Xp.BallTitle")}
            </h3>
          </div>
        </div>
      </div>
